...
public class Shop extends JPanel
{
  ...
  // count when user clicks the button1~6              
   ...
   public void loadBackgroundMusic(String filePath) throws UnsupportedAudioFileException, IOException, LineUnavailableException {
       // Load and play background music
       File soundFile = new File(filePath); // Use the provided filePath directly
   ...
   public Shop(){
      setBackground(Color.black); // white background
      ...
      //base Panel
      base = new JPanel(); 
      base.setBounds(0,0, 880,600); 
      base.setBackground(Color.black); 
      base.setLayout(null); 
      base.addMouseListener(new MyMouseAdapter()); //mouser click event
      add(base); 
      
       //when user success making coffe, frame and panel
      ...
      icon2 = new ImageIcon("./image/americano.png");       
      icon3 = new ImageIcon("./image/latte.png");      
      icon4 = new ImageIcon("./image/choco.png");      
      icon5 = new ImageIcon("./image/mocha.png");      
      icon6 = new ImageIcon("./image/vanila.png");      
      icon7 = new ImageIcon("./image/fail.png"); // fail image
      icon8 = new ImageIcon("./image/background.gif"); // first image(background image)
      icon9 = new ImageIcon("./image/hint.jpg"); //hint image

      //baselabel = shop screen 
      baselabel = new JLabel("", icon1, SwingConstants.CENTER);
      base.add(baselabel); 
      baselabel.setBounds(0,0, 880,600); 
      baselabel.setVisible(false); 
      
      //first scereen (MainDoor)
      mainlabel = new JLabel("", icon8, SwingConstants.CENTER);
      mainlabel.setLayout(new BorderLayout());
      mainlabel.setBounds(0, 0, 880, 600); // Set the size to match the panel's dimensions

      JLabel startText = new JLabel("Click anywhere to start");
      startText.setForeground(Color.white);
      startText.setHorizontalAlignment(JLabel.CENTER);

      mainlabel.add(startText, BorderLayout.SOUTH);

      base.add(mainlabel);
      mainlabel.setBounds(0, 0, 860, 530);

      // Add a mouse listener to start the game when the user clicks anywhere on the screen
      ...
      hint.add(hintimage); 
      hintimage.setBounds(0,0,500,390); 
      ...
      success1.setForeground(Color.green);
      ...
      success3 = new JLabel("Vanilla latte Success", icon6, SwingConstants.CENTER);
      success.add(success3);
      success3.setFont(new Font("Verdana", Font.BOLD, 20));
      success3.setForeground(Color.green); 
      ...
      success4.setForeground(Color.green); 
      ...
      success5.setForeground(Color.green); 
